...
function TBLusuarioConsulta(tx) {
    tx.executeSql('SELECT * FROM usuario where id = "9999"', [], TBLusuarioConsultaGuarda, errorCB);
}
/* LOGUEADO EXITOSAMENTE*/
...
function BuscaUsuario(tx) {
	db.transaction(TBLusuario, errorCB); //Crea la tabla
	db.transaction(BuscaUsuarioConsulta, errorCB);			//Consulta Usuario en la bse de datos
}
/* LOGUEADO LOCALMENTE EN EL MOVIL*/
